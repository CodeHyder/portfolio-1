...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Desenvolvedor Front-End && Pedagogo</h3>
            <p className="home__description">
                Sou criativo e resiliente! Tenho muita vontade e paixão para trabalhar. Conte comigo!
                Vamos conversar?
            </p>
            <a href="https://www.linkedin.com/in/raphael-rodrigues-85ab69168/" target="blank" className="button button--flex">
                Say Hello
                <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
