            ...
            <div className="services__container container grid">
                <div className="services__content">
                    <div>
                        ...
                        <h3 className="services__title">Front <br/> End</h3>
                    </div>
                        ...
                        <div className="services__modal-content">
                            ...
                            <ul className="services__modal-services grid">
                                <li className="services__modal-service">
                                    ...
                                    <p className="services__modal-info">I devolp the user interface</p>
                                </li>
                                ...
                                <li className="services__modal-service">
                                    <i className="uil uil-check-circle 
                                    services__modal-icon"></i>
                                    <p className="services__modal-info">Web page devolpment</p>
                                </li>
                ...
                <div className="services__content">
                    <div>
                        ...
                        <h3 className="services__title">Comunicação | <br/> Inteligencia Emocional</h3>
                    </div>
                ...
                <div className="services__content">
                    <div>
                        ...
                        <h3 className="services__title">Atendimento ao Cliente</h3>
                    </div>
